...
const steps = [
  {
    ...
    description:
      'Import from your invoicing tool or add manually. Invoze works with FreshBooks, QuickBooks, Wave, and more.',
  },
  {
    number: '02',
    title: 'Set your reminder schedule',
    description:
      'Choose when and how often to remind. Use our proven templates or write your own — Invoze handles the rest.',
  },
  {
    number: '03',
